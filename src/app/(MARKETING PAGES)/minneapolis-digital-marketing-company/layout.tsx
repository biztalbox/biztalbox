...
const baseMetadata: Metadata = {
  title: "Minneapolis Digital Marketing Agency | Online Marketing Services In Minneapolis",
  description:
"Get Digital Marketing Services in Minneapolis. We offer affordable pricing for businesses seeking the best Digital Marketing Agency. Hire a Cheap & Low-Cost Online Marketing Company in Minneapolis."};
...
export default function RootLayout({
  ...
  const pageData = createMarketingPageData({
    ...
    path: "/minneapolis-digital-marketing-company",
  ...
  return (
    <>
      <MarketingPageSchema
        pageData={pageData}
        currentUrl={createFullUrl("/minneapolis-digital-marketing-company")}
      />
      {children}
    </>
  );
