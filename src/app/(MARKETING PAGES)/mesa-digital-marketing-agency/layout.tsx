...
const baseMetadata: Metadata = {
  title: "Digital Marketing Services Mesa| Digital Marketing Agency in Mesa ",
  description:
"Grow your business with Biztalbox — a leading digital marketing agency in Mesa. Drive traffic, boost leads, and increase sales with expert marketing solutions."};

export const metadata = createMetadata(
  baseMetadata,
  "/mesa-digital-marketing-agency"
);
...
export default function RootLayout({
  ...
  const pageData = createMarketingPageData({
    ...
    path: "/mesa-digital-marketing-agency",
  ...
  return (
    <>
      <MarketingPageSchema
        pageData={pageData}
        currentUrl={createFullUrl("/mesa-digital-marketing-agency")}
      />
      {children}
    </>
  );
