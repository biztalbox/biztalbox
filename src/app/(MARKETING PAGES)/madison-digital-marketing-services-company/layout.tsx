...
const baseMetadata: Metadata = {
  ...
  description:
"Boost leads & visibility with Biztalbox — Madison's trusted marketing services company. Get proven strategies for measurable growth. Starting today!"};

export const metadata = createMetadata(
  baseMetadata,
  "/madison-digital-marketing-company"
);
...
export default function RootLayout({
  ...
  const pageData = createMarketingPageData({
    ...
    path: "/madison-digital-marketing-company",
  ...
  return (
    <>
      <MarketingPageSchema
        pageData={pageData}
        currentUrl={createFullUrl("/madison-digital-marketing-company")}
      />
      {children}
    </>
  );
