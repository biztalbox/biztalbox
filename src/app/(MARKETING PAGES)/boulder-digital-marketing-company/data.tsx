...
export const faq_data: IFaq[] = [
{
  ...
  answer:
    "At Biztalbox, we offer Branding, content marketing, SEO, social media, advertising, copywriting, graphic design, and motion graphics — all tailored for Boulder businesses.",
},
{
  id: 2,
  question: "Does digital marketing work for small businesses in Boulder?",
  answer:
    " Indeed. Local campaigns make it possible for small Boulder businesses to compete and grow successfully.",
},
{
  id: 3,
  question: "Do you specialize in Boulder SEO?",
  answer:
    "Yes — our local search engine optimization puts your business in front of Boulder customers.",
},
{
  id: 4,
  question: "How soon can I see results?",
  answer:
    "You’ll start noticing stronger brand visibility early on, while SEO and content marketing usually show a measurable return within 3–6 months.",
},
{
  id: 5,
  question: "Do you optimize and run paid ads and social media campaigns?",
  answer:
    "Yes, our Boulder Online Marketing Agency runs paid ads and creative campaigns on social media to drive leads, engagement, and conversions.",
},
];
