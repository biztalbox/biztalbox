...
const baseMetadata: Metadata = {
  title: "Boulder Digital Marketing Company | Full-Service Digital Agency",
  description:
"Hire a Boulder digital marketing company that drives traffic, leads & growth. From SEO & PPC to content marketing and social media — tailored strategies for your brand."};

export const metadata = createMetadata(
  baseMetadata,
  "/boulder-digital-marketing-company"
);
...
export default function RootLayout({
  ...
  const pageData = createMarketingPageData({
    ...
    path: "/boulder-digital-marketing-company",
  ...
  return (
    <>
      <MarketingPageSchema
        pageData={pageData}
        currentUrl={createFullUrl("/boulder-digital-marketing-company")}
      />
      {children}
    </>
  );
