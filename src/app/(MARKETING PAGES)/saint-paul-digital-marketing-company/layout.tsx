...
const baseMetadata: Metadata = {
  title: "Saint Paul Digital Marketing Agency | Online Marketing Services in Saint Paul",
  description:
"Get Digital Marketing Services in Saint Paul. We offer affordable pricing for businesses seeking the best Digital Marketing Agency. Hire a Cheap & Low-Cost Online Marketing Company in Saint Paul."};

export const metadata = createMetadata(
  baseMetadata,
  "/saint-paul-digital-marketing-company"
);
...
export default function RootLayout({
  ...
  const pageData = createMarketingPageData({
    ...
    path: "/saint-paul-digital-marketing-company",
  ...
  return (
    <>
      <MarketingPageSchema
        pageData={pageData}
        currentUrl={createFullUrl("/saint-paul-digital-marketing-company")}
      />
      {children}
    </>
  );
