...
const baseMetadata: Metadata = {
  title: "Arapahoe Digital Marketing Agency | Best Online Marketing Services",
  description:
" Grow your business with Arapahoe’s leading digital marketing agency. Get the best online marketing services to boost traffic, leads, and brand visibility."};

export const metadata = createMetadata(
  baseMetadata,
  "/arapahoe-digital-marketing-company"
);
...
export default function RootLayout({
  ...
  const pageData = createMarketingPageData({
    ...
    path: "/arapahoe-digital-marketing-company",
  ...
  return (
    <>
      <MarketingPageSchema
        pageData={pageData}
        currentUrl={createFullUrl("/arapahoe-digital-marketing-company")}
      />
      {children}
    </>
  );
