...
const baseMetadata: Metadata = {
  title: "Marketing Services Agency Indianapolis | Top Marketing Company",
  description:
"Boost your business with expert marketing services in Indianapolis. Our agency delivers results-driven strategies to grow traffic, leads, and sales."}

export const metadata = createMetadata(
  baseMetadata,
  "/indianapolis-marketing-services"
);
...
export default function RootLayout({
  ...
  const pageData = createMarketingPageData({
    ...
    path: "/indianapolis-marketing-services",
  ...
  return (
    <>
      <MarketingPageSchema
        pageData={pageData}
        currentUrl={createFullUrl("/indianapolis-marketing-services")}
      />
      {children}
    </>
  );
