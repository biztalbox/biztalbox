...
const baseMetadata: Metadata = {
  title: "Digital Marketing Services Colorado | Digital Marketing Agency Colorado ",
  description:
"Grow your business with Biztalbox — a trusted digital marketing agency in Colorado. Drive traffic, boost leads, and achieve real growth with expert marketing solutions."};

export const metadata = createMetadata(
  baseMetadata,
  "/colorado-digital-marketing-company"
);
...
export default function RootLayout({
  ...
  const pageData = createMarketingPageData({
    ...
    path: "/colorado-digital-marketing-company",
  ...
  return (
    <>
      <MarketingPageSchema
        pageData={pageData}
        currentUrl={createFullUrl("/colorado-digital-marketing-company")}
      />
      {children}
    </>
  );
