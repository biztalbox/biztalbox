...
const baseMetadata: Metadata = {
  title: "Marketing Agency in Nashville – Expert Digital Marketing Services",
  description:
"Grow your business with top marketing services in Nashville, Tennessee. SEO, PPC, and social media strategies to boost traffic and sales effectively."};

export const metadata = createMetadata(
  baseMetadata,
  "/nashville-tennessee-marketing-services-company"
);
...
export default function RootLayout({
  ...
  const pageData = createMarketingPageData({
    ...
    path: "/nashville-tennessee-marketing-services-company",
  ...
  return (
    <>
      <MarketingPageSchema
        pageData={pageData}
        currentUrl={createFullUrl("/nashville-tennessee-marketing-services-company")}
      />
      {children}
    </>
  );
