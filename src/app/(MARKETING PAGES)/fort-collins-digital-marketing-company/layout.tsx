...
const baseMetadata: Metadata = {
  title: "Digital Marketing Services Fort Collins | Digital Marketing Agency Fort Collins ",
  description:
"Grow your business with Biztalbox — a leading digital marketing agency in Fort Collins. Boost visibility, drive leads, and increase sales with proven marketing strategies."};

export const metadata = createMetadata(
  baseMetadata,
  "/fort-collins-digital-marketing-company"
);
...
export default function RootLayout({
  ...
  const pageData = createMarketingPageData({
    ...
    path: "/fort-collins-digital-marketing-company",
  ...
  return (
    <>
      <MarketingPageSchema
        pageData={pageData}
        currentUrl={createFullUrl("/fort-collins-digital-marketing-company")}
      />
      {children}
    </>
  );
