...
const baseMetadata: Metadata = {
  ...
  description:
    "Get in touch with our team for personalized digital marketing and web development solutions. We're here to answer your questions and help your business grow.",
};
