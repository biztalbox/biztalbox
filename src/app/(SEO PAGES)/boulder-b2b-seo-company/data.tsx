...
{
  id: 1,
  question: "What does your B2B SEO Agency Boulder do?",
  answer:
    "We improve your website's visibility and enhance your online presence so that the right businesses can find you and trust you.",
},
{
  id: 2,
  question: "How long until I see results?",
  answer:
    "For most clients, significant improvement is noticeable during the first 3-6 months, and consistent improvement after that.",
},
{
  id: 3,
  question: "Can SEO produce qualified B2B leads?",
  answer:
    "Absolutely. We have expertise in local and niche optimization to target Boulder's distinct business community.",
},
{
  id: 4,
  question: "Do you offer Boulder-specific keyword targeting?",
  answer:
    "Absolutely. Local SEO assists smaller businesses in competing with large companies by enhancing local search visibility."
},
{
  id: 5,
  question: "Are your SEO practices safe?",
  answer:
    "Yes, at Biztalbox, we only employ tested, ethical methods to achieve sustainable, long-term outcomes.",
},
];
