...
{
  id: 1,
  question: "Do you offer SEO services tailored to specific industries in Mesa?",
  answer:
    "Yes. Our strategies cater to a variety of sectors, including manufacturers, SaaS companies, and local service providers",
},
{
  id: 2,
  question: "How long does it take to see results?",
  answer:
    "The majority of Mesa clients experience improvements within three to six months, and their returns continue to grow over time.",
},
{
  id: 3,
  question: "Can SEO boost my sales?",
  answer:
    "Absolutely. When you get the right keywords and intent, seo drives leads that are ready to convert.",
},
{
  id: 4,
  question: "Is SEO good for small businesses in Mesa?",
  answer:
    "Absolutely. Local SEO enables small businesses to compete with the big ones by increasing their search visibility. ",
},
];
