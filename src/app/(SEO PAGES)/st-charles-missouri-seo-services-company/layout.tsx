...
export const metadata = createMetadata(
  baseMetadata,
  "/st-charles-missouri-seo-services-company"
);
...
export default function RootLayout({
  ...
  const pageData = createMarketingPageData({
    ...
    path: "/st-charles-missouri-seo-services-company",
  ...
  return (
    <>
      <MarketingPageSchema
        pageData={pageData}
        currentUrl={createFullUrl("/st-charles-missouri-seo-services-company")}
      />
      {children}
    </>
  );
