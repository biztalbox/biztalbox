...
const baseMetadata: Metadata = {
  title: "B2B SEO Services Company in Nashville, Tennessee",
  description:
"Boost your online visibility with expert B2B SEO services in Nashville, Tennessee. Drive quality leads and growth with Biztalbox's proven SEO strategies."};

export const metadata = createMetadata(
  baseMetadata,
  "/nashville-tennessee-b2b-seo-services-company"
);
...
export default function RootLayout({
  ...
  const pageData = createMarketingPageData({
    ...
    path: "/nashville-tennessee-b2b-seo-services-company",
  ...
  return (
    <>
      <MarketingPageSchema
        pageData={pageData}
        currentUrl={createFullUrl("/nashville-tennessee-b2b-seo-services-company")}
      />
      {children}
    </>
  );
