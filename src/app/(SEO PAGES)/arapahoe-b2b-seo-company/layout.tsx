...
const baseMetadata: Metadata = {
  title: "B2B SEO Services Arapahoe | Best B2B SEO Company in Arapahoe",
  description:
    "Boost your business growth with Biztalbox — Arapahoe's trusted B2B SEO company. Improve visibility, attract qualified leads, and maximize your online performance.",
};

export const metadata = createMetadata(
  baseMetadata,
  "/arapahoe-b2b-seo-company"
);
...
export default function RootLayout({
  ...
  return (
    <>
      <MarketingPageSchema
        pageData={pageData}
        currentUrl={createFullUrl("/arapahoe-b2b-seo-company")}
      />
      {children}
    </>
  );
