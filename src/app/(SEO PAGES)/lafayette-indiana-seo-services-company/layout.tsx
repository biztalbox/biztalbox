...
const baseMetadata: Metadata = {
  title: "SEO Services Agency Lafayette | Best SEO Company Lafayette",
  description:
"Looking for top SEO services in Lafayette? Our expert SEO company in Lafayette, Indiana delivers proven strategies to boost your website traffic and rankings."
}

export const metadata = createMetadata(
  baseMetadata,
  "/lafayette-indiana-seo-services-company"
);
...
export default function RootLayout({
  ...
  const pageData = createMarketingPageData({
    ...
    path: "/lafayette-indiana-seo-services-company",
  ...
  return (
    <>
      <MarketingPageSchema
        pageData={pageData}
        currentUrl={createFullUrl("/lafayette-indiana-seo-services-company")}
      />
      {children}
    </>
  );
