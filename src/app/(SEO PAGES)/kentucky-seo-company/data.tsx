...
export const faq_data: IFaq[] = [
  {
    id: 1,
    question: "Do you provide SEO for certain industries in Kentucky?",
    answer:
      "Yes. We engage with manufacturing, SaaS, and service enterprises through strategies customized for each industry.",
  },
  {
    id: 2,
    question: "When does SEO deliver results?",
    answer:
      "Most Kentucky customers see improvement in three to six months, depending on competition and website health.",
  },
  {
    id: 3,
    question: "Can SEO boost sales?",
    answer:
      "Absolutely. SEO-optimized keywords bring high-intent visitors willing to convert into paying customers.",
  },
  {
    id: 4,
    question: "Is SEO worth it for small businesses in Kentucky?",
    answer:
      "Yes. Local SEO will help give smaller companies a chance to rank and show up in Google Maps and search results, helping them compete against bigger competitors.",
  },
  {
    id: 5,
    question: "Will local SEO actually help Kentucky-based businesses?",
    answer:
      "Absolutely. Local SEO guarantees that if customers in your region search for your service, your business is the first to be shown.",
  },
];
