...
const baseMetadata: Metadata = {
  title: "SEO Company Minneapolis | Best SEO Services in Minneapolis",
  description:
    "Grow your business with the leading SEO Company in Minneapolis. Biztalbox delivers powerful SEO services to boost traffic, leads, and online visibility.",
};
...
export default function RootLayout({
  ...
  return (
    <>
      <MarketingPageSchema
        pageData={pageData}
        currentUrl={createFullUrl("/minneapolis-seo-company")}
      />
      {children}
    </>
  );
