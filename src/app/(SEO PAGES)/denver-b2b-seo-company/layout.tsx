...
const baseMetadata: Metadata = {
  ...
  description:
"Looking for top B2B SEO in Denver? Our Denver-based SEO company specializes in helping B2B businesses boost search rankings, leads & growth. Let’s get you found."};
