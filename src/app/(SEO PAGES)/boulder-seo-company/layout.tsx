...
const baseMetadata: Metadata = {
  title: "SEO Services Agency Boulder | Best SEO Company in Boulder",
  description:
"Boost your online presence with Biztalbox — Boulder’s trusted SEO services agency. Improve rankings, attract quality traffic, and grow your business faster."};
...
export default function RootLayout({
  ...
  return (
    <>
      <MarketingPageSchema
        pageData={pageData}
        currentUrl={createFullUrl("/boulder-seo-company")}
      />
      {children}
    </>
  );
