...
const baseMetadata: Metadata = {
  title: "SEO Services Agency Knoxville | Best SEO Company in Knoxville",
  description:
"Professional SEO services in Knoxville – Boost your website traffic, improve search rankings, and grow sales with the best SEO company in Knoxville."};

export const metadata = createMetadata(
  baseMetadata,
  "/knoxville-tennessee-seo-services-company"
);
...
export default function RootLayout({
  ...
  const pageData = createMarketingPageData({
    ...
    path: "/knoxville-tennessee-seo-services-company",
  ...
  return (
    <>
      <MarketingPageSchema
        pageData={pageData}
        currentUrl={createFullUrl("/knoxville-tennessee-seo-services-company")}
      />
      {children}
    </>
  );
