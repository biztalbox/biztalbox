...
export const metadata = createMetadata(
  baseMetadata,
  "/rutherford-tennessee-seo-services-company"
);
...
export default function RootLayout({
  ...
  const pageData = createMarketingPageData({
    ...
    path: "/rutherford-tennessee-seo-services-company",
  ...
  return (
    <>
      <MarketingPageSchema
        pageData={pageData}
        currentUrl={createFullUrl("/rutherford-tennessee-seo-services-company")}
      />
      {children}
    </>
  );
