...
const baseMetadata: Metadata = {
  title: "SEO Services Company Colorado | Best SEO Agency in Colorado",
  description:
"SEO Services Company Colorado | Best SEO Agency in Colorado — Boost your online presence with Biztalbox, improve rankings, drive traffic, and grow your business with expert SEO services."};
...
export default function RootLayout({
  ...
  return (
    <>
      <MarketingPageSchema
        pageData={pageData}
        currentUrl={createFullUrl("/colorado-seo-company")}
      />
      {children}
    </>
  );
