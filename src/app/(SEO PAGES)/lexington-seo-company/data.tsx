...
export const faq_data: IFaq[] = [
  {
    id: 1,
    question:
      "Do you provide SEO tailored to particular industries in Lexington?",
    answer:
      "Yes. We make industry-specific campaigns for manufacturing businesses, SaaS businesses, and service businesses in Lexington.",
  },
  {
    id: 2,
    question: "How soon does SEO deliver results?",
    answer:
      "The majority of clients notice tangible improvements in three to six months, depending on site performance and competition.",
  },
  {
    id: 3,
    question: "Can SEO make my business sales grow?",
    answer:
      "Absolutely. With high-intent keywords targeting, SEO drives in people who are willing to convert into customers.",
  },
  {
    id: 4,
    question: "Is SEO worth the cost for Lexington small businesses?",
    answer:
      "Absolutely. Local SEO can get small businesses listed on Google Maps and take on larger companies.",
  },
  {
    id: 5,
    question:
      "How do local SEO services assist my Lexington business in reaching more customers?",
    answer:
      "By optimizing your Google Business Profile, google map listings, and local keywords, we assist local customers near you to come across your business before your competitors.",
  },
];
