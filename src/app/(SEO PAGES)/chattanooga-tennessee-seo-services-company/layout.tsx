...
export const metadata = createMetadata(
  baseMetadata,
  "/chattanooga-tennessee-seo-services-company"
);
...
export default function RootLayout({
  ...
  const pageData = createMarketingPageData({
    ...
    path: "/chattanooga-tennessee-seo-services-company",
  ...
  return (
    <>
      <MarketingPageSchema
        pageData={pageData}
        currentUrl={createFullUrl("/chattanooga-tennessee-seo-services-company")}
      />
      {children}
    </>
  );
