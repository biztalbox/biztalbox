              ...
              <div className="project-details-1-right p-relative">
                <div className="project-details-1-title-box">
                  ...
                  <p>
                    ...
                    Good copywriters don&apo;t just make things sound pretty — they do the heavy lifting.

                    It is the voice behind a brand, the hook that captures you in an ad, and the warmth that greets you in an email. Copywriters aren&apo;t ust writers, they&apo;re strategists who can spin browsers into buyers. Their words lead, woo, convert. Every sentence on websites, campaigns, social media moves the reader a step closer to action.
                  </p>
                </div>
                <div className="project-details-1-info-wrap">
                  <div className="project-details-1-info">
                    ...
                    <p>
                      ...
                      They don&apo;t write content; they calibrate words, tone, cadence and structure to make every word count.
                    </p>
                  </div>
                  ...
                  <div className="project-details-1-info">
                    ...
                    <p>
                      ...
                      it&apo;s just a matter of finding the right voice, the right angle, and a little magic.
                    </p>
                  </div>
                  <div className="project-details-1-info">
                  ...
                  <div className="project-details-1-info">
                    ...
                    <p>
                      ...
                      what&apo;s trending and being able to instantly render it into content that&apo;s smart, fast and just impossible to ignore.
                    </p>
                  </div>
                  <div className="project-details-1-info">
                    <span>The Grammar Guardian-</span>
                    <p>
                      Error-Free Content – The power to remove typos and omissions, rewriting every sentence until it&apo;s free of errors.
                      Proofreading is, after all, a nonnegotiable part of the job — it&apo;s that final layer of polish that makes strong copy shine.
                    </p>
                  </div>
                  <div className="project-details-1-info">
