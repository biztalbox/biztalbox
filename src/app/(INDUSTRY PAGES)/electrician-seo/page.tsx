        ...
        <div id="smooth-content">
          <main style={{ overflow: "hidden" }}>
            ...
            <div className="container">
              ...
              <section className="content-section content-prose">
                <h2 className="section-heading">Electrician SEO Explained: How Electricians Get Found on <Link href="https://biztalbox.com/blog/google-seo-tools" className="text-primary">Google</Link></h2>
