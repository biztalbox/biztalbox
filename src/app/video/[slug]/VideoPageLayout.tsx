...
export default function VideoPageLayout({ data }: { data: Record<string, unknown> }) {
  ...
  const AGENCY_IMAGES = useMemo(
    () =>
      [
        "/assets/image/video_service/social.webp",
        "/assets/image/video_service/promotional.webp",
        "/assets/image/video_service/motion_graphics.webp",
        "/assets/image/video_service/educational.webp",
        "/assets/image/video_service/instagram.webp",
        "/assets/image/video_service/3d_2d.webp",
        "/assets/image/video_service/youtbe.webp",
        "/assets/image/video_service/ai_edit.webp",
      ] as const,
    [],
  );
        ...
        <section className="bg-zinc-50 py-10 text-zinc-900 dark:bg-[#121212] dark:text-white sm:py-12 lg:py-14">
          <div className="container">
            <div className="grid gap-10 lg:grid-cols-2 lg:items-start lg:gap-x-10 lg:gap-y-0 xl:gap-x-12">
              <div className="">
                <p className="mb-3 text-2xl tracking-wide text-zinc-800 dark:text-zinc-400">{heroKicker}</p>
        ...
        <section className="bg-zinc-60 pb-14 pt-2 dark:bg-[#121212] sm:pb-16">
          <div className="container">
            <div className="rounded-3xl bg-zinc-100 px-6 py-8 shadow-sm dark:bg-[#1e1e1e] dark:shadow-none sm:px-8 sm:py-10 lg:px-12 lg:py-12">
              <h3 className="mb-10 text-left text-2xl text-zinc-900 dark:text-white sm:text-2xl">{statsTitle}</h3>
                  ...
                  <div key={index} className="grid grid-cols-1 md:grid-cols-2 items-center gap-10">
                    <div className={`flex flex-col !order-2 ${textOrder}`}>
                      ...
                      {(item.paragraphs.length ? item.paragraphs : [""]).slice(0, 4).map((p, i) => (
                        <p
                          key={i}
                          className="mt-4 text-justify text-sm leading-relaxed text-zinc-600 dark:text-zinc-400 sm:text-[0.9375rem]"
                        >
