  ...
  useGSAP(
    () => {
      ...
      const mountScroll = () => {
        ...
        addToCartTl.to(smoRef.current.scale, { x:0.3, y: 0.3,z:0.3, duration: 0, ease: "power3.inOut" }, 0);
        addToCartTl.to(smoRef.current.position, { y: "-=40", x: "+=50", z: "-=30", duration: 2, ease: "power3.inOut" }, 1.5);
        ...
        addToCartTl.to(adsRef.current.scale, { x:0.1, y: 1,z:0.3, duration: 0, ease: "power3.inOut" }, 0);
        addToCartTl.to(adsRef.current.position, { y: "-=30", x: "-=70", z: "+=150", duration: 2, ease: "power3.inOut" }, 1.5);
        addToCartTl.to(appdevRef.current.scale, { x:0.1, y: 10,z:0.3, duration: 0, ease: "power3.inOut" }, 0);
        addToCartTl.to(appdevRef.current.position, { y: "-=1", x: "-=70", z: "+=150", duration: 2, ease: "power3.inOut" }, 1.5);
        addToCartTl.to(algoRef.current.scale, { x:0.6, y: 1,z:0.3, duration: 0, ease: "power3.inOut" }, 0);
        addToCartTl.to(algoRef.current.position, { y: "-=30", x: "-=70", z: "+=10", duration: 2, ease: "power3.inOut" }, 1.5);
